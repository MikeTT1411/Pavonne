...
<html lang="en">
	...
	<head>
		...
		<meta charset="utf-8">
	  	...
	  	<meta name="author" content="Pavonne Barbiere">
  		...
  		<div id="wrapper">
			...
			<div id="content-wrapper" class="d-flex flex-column">
			  	...
			  	<div id="content">
					...
					<!-- Topbar -->
					<nav class="navbar bg-dark navbar-expand navbar-light topbar mb-4 static-top shadow">
					  	...
					  	<ul class="navbar-nav ml-auto">
							<li class="nav-item">
		              			<a class="nav-link" href="../" target="_blank">
		                			...
		                			<span style="margin-left: 5px;">Ver website</span>
		              			</a>
		          			</li>
