...
?>
        <div class="container-fluid">
            ...
            <?php
                ...
                if($do == 'Manage')
                {
                    $stmt = $con->prepare("SELECT * FROM servicios s, categoriasservicios sc where s.categoriaID = sc.categoriaID");
                    $stmt->execute();
                                    ...
                                    <?php
                                        foreach($rows_services as $service)
                                        {
                                            echo "<tr>";
                                                ...
                                                echo "</td>";
                                                echo "<td>";
                                                    echo $service['duracion'];
                                                echo "</td>";
                                                echo "<td>";
                                                    $delete_data = "delete_".$service["servicioID"];
                                                    ?>
                                                        <ul class="list-inline m-0">

                                                            <li class="list-inline-item" data-toggle="tooltip" title="Editar">
                                                                <button class="btn btn-success btn-sm rounded-0">
                                                                    <a href="services.php?do=Edit&service_id=<?php echo $service['servicioID']; ?>" style="color: white;">
                                                                    ...
                                                                    <div class="modal-dialog" role="document">
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body">
                                                                                ¿Estás seguro de que quieres borrar este servicio "<?php echo $service['nombre']; ?>"?
                                                                            </div>
                                                                            <div class="modal-footer">
                                                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
                                                                                <button type="button" data-id = "<?php echo $service['servicioID']; ?>" class="btn btn-danger delete_service_bttn">Borrar</button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                        ...
                        <div class="card-body">
                            <form method="POST" action="services.php?do=Add">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        ?>
                                        <div class="form-group">
                                            <label for="service_category">Categorías Servicios</label>
                                            <select class="custom-select" name="service_category">
                                                <?php
                                                    foreach($rows_categories as $category)
                                                    {
                                                        echo "<option value = '".$category['categoriaID']."'>";
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" value="<?php echo (isset($_POST['service_duration']))?htmlspecialchars($_POST['service_duration']):'' ?>" placeholder="Duración" name="service_duration">
                                            <?php
                                                ...
                                                if(isset($_POST['add_new_service']))
                                                {
                                                    if(empty(test_input($_POST['service_duration'])))
                                                    {
                                                        ?>
                                                            <div class="invalid-feedback" style="display: block;">
                                                                La duración del servicio es requerida.
                                                            </div>
                                                        <?php
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" value="<?php echo (isset($_POST['service_price']))?htmlspecialchars($_POST['service_price']):'' ?>" placeholder="Precio" name="service_price">
                                            <?php
                                ...
                                <button type="submit" name="add_new_service" class="btn btn-primary">Añadir servicio</button>
                            ...
                            <?php
                                ...
                                if(isset($_POST['add_new_service']) && $_SERVER['REQUEST_METHOD'] == 'POST' && $flag_add_service_form == 0)
                                {
                                    ...
                                    try
                                    {
                                        $stmt = $con->prepare("insert into servicios(nombre,descripcion,precio,duracion,categoriaID) values(?,?,?,?,?) ");
                                        $stmt->execute(array($service_name,$service_description,$service_price,$service_duration,$service_category));
                                        
                                        ?> 

                                            <script type="text/javascript">
                                                swal("Nuevo Servicio","Un nuevo servicio ha sido creado exitosamente", "success").then((value) => 
                                                {
                ...
                elseif($do == "Edit")
                {
                    ...
                    if($service_id)
                    {
                        $stmt = $con->prepare("Select * from servicios where servicioID = ?");
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <form method="POST" action="services.php?do=Edit&service_id=<?php echo $service_id; ?>">
                                        <input type="hidden" name="service_id" value="<?php echo $service['servicioID'];?>">

                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="service_name">Servicio</label>
                                                    <input type="text" class="form-control" value="<?php echo $service['nombre'] ?>" placeholder="Servicio" name="service_name">
                                                    <?php
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="custom-select" name="service_category">
                                                        <?php
                                                            foreach($rows_categories as $category)
                                                            {
                                                                if($category['categoriaID'] == $service['categoriaID'])
                                                                {
                                                                    echo "<option value = '".$category['categoriaID']."' selected>";
                                                                        echo $category['categoria'];
                                                                    echo "</option>";
                                                                }
                                                                else
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="service_duration">Duración(min)</label>
                                                    <input type="text" class="form-control" value="<?php echo $service['duracion'] ?>" placeholder="Duración del servicio" name="service_duration">
                                                    <?php
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="service_price">Precio($)</label>
                                                    <input type="text" class="form-control" value="<?php echo $service['precio'] ?>" placeholder="Precio del servicio" name="service_price">
                                                    <?php
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="service_description">Descripción</label>
                                                    <textarea class="form-control" name="service_description" style="resize: none;"><?php echo $service['descripcion']; ?></textarea>
                                                    <?php
                                    ...
                                    <?php
                                        if(isset($_POST['edit_service_sbmt']) && $_SERVER['REQUEST_METHOD'] == 'POST' && $flag_edit_service_form == 0)
                                        {
                                            ...
                                            try
                                            {
                                                $stmt = $con->prepare("update servicios set nombre = ?, descripcion = ?, precio = ?, duracion = ?, categoriaID = ? where servicioID = ? ");
