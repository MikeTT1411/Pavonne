...
$('.cancel_appointment_button').click(function()
{
    ...
    $.ajax({
        ...
        success: function (data) 
        {
            ...
            swal("Cita Cancelada","La cita fue cancelada exitosamente", "success").then((value) => 
            {
...
$('.delete_service_bttn').click(function()
{
    ...
    $.ajax(
    {
        ...
        success: function (data) 
        {
            swal("Borrar servicio","El servicio se ha borrado exitosamente", "success").then((value) => {
...
$('.delete_product_bttn').click(function()
{
    ...
    var do_product = "Delete_P";

    $.ajax(
    {
        url:"ajax_files/services_ajax.php",
        method:"POST",
        data:{product_id:product_id,do_product:do_product},
        success: function (data) 
        {
            swal("Borrar producto","El producto se ha borrado exitosamente", "success").then((value) => {
